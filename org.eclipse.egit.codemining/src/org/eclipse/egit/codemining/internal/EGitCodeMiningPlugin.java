 ...
 */
public class EGitCodeMiningPlugin extends AbstractUIPlugin {

	// The plug-in ID
	public static final String PLUGIN_ID = "org.eclipse.egit.codemining"; //$NON-NLS-1$
	 ...
	 */
	public static EGitCodeMiningPlugin getDefault() {
		return plugin;
	}
